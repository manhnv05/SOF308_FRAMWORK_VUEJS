<template>
    <div>
      <!-- Hero Section -->
      <div class="hero overlay inner-page bg-dark py-5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center pt-5">
            <div class="col-lg-6">
              <h1 class="heading text-white mb-3" data-aos="fade-up">Liên hệ chúng tôi</h1>
            </div>
          </div>
        </div>
      </div>
  ...
  <script setup>
  // Không cần xử lý logic ở đây trừ khi có xử lý bổ sung.
  </script>
